## Two Activities Classwork - Solution Code

The TwoActivities app consists of two activities, a main activity and a second activity. It uses an explicit Intent to launch one Activity from another, and uses Intent extras to pass data between them.
